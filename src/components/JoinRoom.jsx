    ...
    return (
        <div className="flex flex-col items-center justify-around  min-h-screen">
            ...
            <form className="flex flex-col items-center -mt-10 " onSubmit={handleJoin}>
                ...
                <button className="px-6 py-2 mb-4 sm:mb-0 sm:mr-4 bg-white font-irish-grover text-blue-900 rounded-md hover:bg-gray-200 transition-colors duration-300 font-bold" type="submit">Join Room</button>
            </form>
